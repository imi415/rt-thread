...
//    PORT1->PCR[5]   = PORT_PCR_MUX(2) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FC3_5 D[2] */
    ...
    /* SPI */
    PORT3->PCR[8]   = PORT_PCR_MUX(8) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FLEXSPI0, A_D0 */
    PORT3->PCR[9]   = PORT_PCR_MUX(8) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FLEXSPI0, A_D1 */
    PORT3->PCR[10]  = PORT_PCR_MUX(8) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FLEXSPI0, A_D2 */
    PORT3->PCR[11]  = PORT_PCR_MUX(8) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FLEXSPI0, A_D3 */
    PORT3->PCR[7]   = PORT_PCR_MUX(8) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FLEXSPI0, A_CLK */
    PORT3->PCR[0]   = PORT_PCR_MUX(8) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);     /* FLEXSPI0, A_SS0 */
...
//    PORT4->PCR[16]   = PORT_PCR_MUX(11) | PORT_PCR_PS(0) | PORT_PCR_PE(1) | PORT_PCR_IBE(1);     /* CAN */
    ...
    /* SmartDMA Camera */
    PORT2->PCR[2]  = PORT_PCR_MUX(1) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_CLKIN */

    PORT0->PCR[11] = PORT_PCR_MUX(0) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_HSYNC */
    PORT0->PCR[4]  = PORT_PCR_MUX(0) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_VSYNC */
    PORT0->PCR[5]  = PORT_PCR_MUX(0) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1) | PORT_PCR_PFE(1); /* CAM_PCLK  */

    PORT1->PCR[11] = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D7  */
    PORT1->PCR[10] = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D6  */
    PORT3->PCR[5]  = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D5  */
    PORT3->PCR[4]  = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D4  */
    PORT1->PCR[7]  = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D3  */
    PORT1->PCR[6]  = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D2  */
    PORT1->PCR[5]  = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D1  */
    PORT1->PCR[4]  = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_D0  */

    PORT1->PCR[18] = PORT_PCR_MUX(0) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_PDOWN  */
    PORT1->PCR[19] = PORT_PCR_MUX(0) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1); /* CAM_RST  */

    PORT3->PCR[2]  = PORT_PCR_MUX(2) | PORT_PCR_PS(1) | PORT_PCR_PE(1) | PORT_PCR_IBE(1) | PORT_PCR_ODE(1); /* CAM_SDA  */
    PORT3->PCR[3]  = PORT_PCR_MUX(2) | PORT_PCR_PS(1) | PORT_PCR_PE(1) | PORT_PCR_IBE(1) | PORT_PCR_ODE(1); /* CAM_SCL  */

    PORT3->PCR[18] = PORT_PCR_MUX(7) | PORT_PCR_PS(0) | PORT_PCR_PE(0) | PORT_PCR_IBE(1);
}
